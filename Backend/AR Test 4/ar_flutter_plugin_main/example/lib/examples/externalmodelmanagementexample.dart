...
//         .collection(
//             collectionRef: FirebaseFirestore.instance.collection('anchors'))
...
// //     // Create a Query object to filter documents based on location and radius
// //     CollectionReference<Map<String, dynamic>> anchorCollectionRef =
// //         anchorCollection; // Assuming 'anchors' is your collection

// //     Query query = anchorCollection.where('position', isLessThan: GeoPoint(
// //         latitude: location.latitude + radius,
// //         longitude: location.longitude + radius),
// //     ).where('position', isGreaterThanOrEqualTo: GeoPoint(
// //         latitude: location.latitude - radius,
// //         longitude: location.longitude - radius));

// //     // Use the Query object within the 'collection' method
// //     Stream<List<DocumentSnapshot>> stream = geo!
