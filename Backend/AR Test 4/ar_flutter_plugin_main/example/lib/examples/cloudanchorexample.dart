...
class FirebaseManager {
  ...
  //         firestore!.collection('anchors'); // Assuming 'anchors' is your collection name
  //     Query query = anchorCollectionRef.where('position', isLessThan: GeoPoint(
  ...
  //     GeoFireCollectionRef stream = geo!
