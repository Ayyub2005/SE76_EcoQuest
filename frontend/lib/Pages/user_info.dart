...
// //             child: Container(
// //               width:
// //                   150.0, // Adjusted width to accommodate the heart image and the linear percentage indicators
// //               height:
...
// //                   Positioned(
// //                     left:
// //                         30.0, // Adjusted left position to create space for the heart image
// //                     top:
// //                         3.0, // Adjusted top position to center the HP indicator vertically
// //                     right:
// //                         2.0, // Adjusted right position to leave space for the border
// //                     bottom:
// //                         28.0, // Adjusted bottom position to leave space for the border and XP indicator
// //                     child: Container(
...
// //                         lineHeight:
// //                             20.0, // Adjusted line height to match the height of the heart image
// //                         percent: 1.0,
// //                         padding: EdgeInsets
// //                             .zero, // Removed padding to ensure full width of the container
...
// //                         30.0, // Adjusted left position to create space for the heart image
// //                     top:
// //                         25.0, // Adjusted top position to center the XP indicator vertically
// //                     right:
// //                         2.0, // Adjusted right position to leave space for the border
// //                     bottom:
// //                         3.0, // Adjusted bottom position to leave space for the border
// //                     child: Container(
// //                       decoration: BoxDecoration(
// //                         border: Border.all(color: Colors.white70, width: 2.0),
// //                       ),
...
// //             ),
// //             const SizedBox(
// //                 height: 5), // Vertical spacing between name and level
// //             // Level
// //             Container(
// //               padding: const EdgeInsets.all(4),
// //               decoration: const BoxDecoration(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  // HP Indicator
                  // Add your HP Indicator here

                  // XP Indicator
                  // Add your XP Indicator here
                ],
              ),
            ),
          ),
